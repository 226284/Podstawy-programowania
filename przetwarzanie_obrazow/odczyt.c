...
int main() {
  ...
  do{
    ...
    {
      case 1:
	  printf("\nWybrano pozycjê 1 - Wczytywanie obrazu\n");
      ...
      case 2:
	  printf("\nWybrano pozycjê 2 - (Pó³)Progowanie bieli\n");
	  printf("\nPodaj próg bieli [0 - 100]:  ");
	  scanf("%d",&prog);
      ...
      case 3:
	  printf("\nWybrano pozycjê 3 - Korekcja gamma\n");
	  
	  printf("\nPodaj wspó³czynnik gamma: \n");
	  scanf("%f",&gamma);
      ...
      case 4:
	  printf("\nWybrano pozycjê 4 - Rozmywanie w pionie\n");
      ...
      case 5:
	  printf("\nWybrano pozycjê 5 - Rozci±ganie histogramu\n");
      ...
      case 6:
	  printf("\nWybrano pozycjê 6 - Wy¶wietlanie oryginalnego obrazu\n");
      ...
      case 7:
	  printf("\nWybrano pozycjê 7 - Zapis obrazu do pliku\n");
	  ...
	  break;
       ...
       case 8:
	  printf("\nKoniec dzia³ania programu\n");
	  return 0;
      
       default:
	  printf("\nProszê podaæ poprawn± liczbê!\n");
	  break;
    }
  }while(1);
